...
public class UserNoticeListItem
{
    ...
    public UserNoticeListItem(){}
    public UserNoticeListItem(int num, String title, String body, Date startDate, Date endDate, Date makeDate, int type, int delete, int close)
    {
        this.num = num;
        this.title = title;
        this.body = body;
