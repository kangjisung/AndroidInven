...
public class _UserNoticeRecyclerViewAdapter extends RecyclerView.Adapter<_UserNoticeRecyclerViewAdapter.NoticeRecyclerViewHolder>
{
    private ArrayList<_UserNoticeRecyclerViewItem> noticeListViewItemRecycler = new ArrayList<_UserNoticeRecyclerViewItem>();
    ...
    public _UserNoticeRecyclerViewAdapter.NoticeRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType)
    {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.user_notice_listitem, parent, false);
        _UserNoticeRecyclerViewAdapter.NoticeRecyclerViewHolder vh = new _UserNoticeRecyclerViewAdapter.NoticeRecyclerViewHolder(v);
    ...
    {
        final _UserNoticeRecyclerViewItem noticeRecyclerViewItem = noticeListViewItemRecycler.get(position);
    ...
    {
        _UserNoticeRecyclerViewItem addItemList = new _UserNoticeRecyclerViewItem();
