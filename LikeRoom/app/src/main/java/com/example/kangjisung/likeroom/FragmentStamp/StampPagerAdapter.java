...
{
    public class StampPageItem {
        int pageNumber;
        int numOfStamp;

        StampPageItem(int _pageNumber, int _numOfStamp){
    ...
    ArrayList<StampPageItem> stampPageItemList;

    public StampPagerAdapter(FragmentManager fm, int mNumOfStamp) {
        super(fm);
        stampPageList
        stampPageItemList = new ArrayList<StampPageItem>();
        ...
        for(int p = 0; p< mNumOfPage; p++)
        {
            ...
            StampPageItem addPage = new StampPageItem(p, nowStamp);

            stampPageItemList.add(addPage);
        }
    }
