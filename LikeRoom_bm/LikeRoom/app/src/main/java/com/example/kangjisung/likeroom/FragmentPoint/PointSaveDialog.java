...
public class PointSaveDialog extends Dialog {
    ...
    public PointSaveDialog(Context context, String title, String content, View.OnClickListener backListener, View.OnClickListener okListener) {
    ...
    public void playInputBoxAnimation(int start, int end) {
        final RelativeLayout layoutInputBox = (RelativeLayout)findViewById(R.id.layout_inputbox);
